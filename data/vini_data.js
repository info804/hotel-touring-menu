...
const VINI_DATA = {
  ...
  categories: [
    ...
    // --------------------------------------------------------
    {
      ...
      name: "BOLLICINE",
      items: [
        { name: "VALDOBBIADENE IL FONDATORE DOCG",               producer: "Cantina Valdo",          notes: "",                                                          bottle: "28.00",  glass: "" },
        { name: "Brut — Franciacorta DOCG",                      producer: "Cantina Plozza",         notes: "",                                                          bottle: "38.00",  glass: "" },
        { name: "ROSÈ — Franciacorta DOCG",                      producer: "Cantina Plozza",         notes: "",                                                          bottle: "42.00",  glass: "" },
        { name: "MAXIMUM BRUT — Trento DOC",                     producer: "Cantina Ferrari",        notes: "",                                                          bottle: "40.00",  glass: "" },
        { name: "TRENTO DOC",                                    producer: "Cantina Madonna delle Vittorie", notes: "",                                                   bottle: "35.00",  glass: "" },
    ...
    // --------------------------------------------------------
    {
      ...
      items: [
        {
          name: "LAGREIN ROSÉ",
          producer: "Cantina Madonna delle Vittorie",
    ...
    // --------------------------------------------------------
    {
      ...
      items: [
        { name: "ALISIO SASSELLA SUPERIORE DOCG 0,375 L",    producer: "Cantina Nera", notes: "Nebbiolo, sottozona Sassella. Elegante, note di frutti rossi e piacevole mineralità",                                     bottle: "14.00", glass: "" },
        { name: "ALISIO SASSELLA SUPERIORE DOCG 0,75 L",     producer: "Cantina Nera", notes: "Nebbiolo, sottozona Sassella. Elegante, note di frutti rossi e piacevole mineralità",                                     bottle: "26.00", glass: "" },
        { name: "SOREL ALPI RETICHE IGT",                    producer: "Cantina Nera", notes: "Nebbiolo dal carattere pieno e rotondo. Profumi intensi di frutta matura e leggere note speziate",                       bottle: "41.00", glass: "" },
        { name: "INFERNO RISERVA AL CARMINE DOCG",           producer: "Cantina Nera", notes: "Grande tipicità valtellinese: profumo intenso, gusto asciutto e deciso",                                                  bottle: "41.00", glass: "" },
        { name: "\"PARADISO\" RISERVA DOCG",                 producer: "Cantina Nera", notes: "Vino elegante e strutturato, profumi di frutti rossi e leggere note speziate",                                           bottle: "42.00", glass: "" },
        { name: "\"MESSERE\" SFURZAT VALTELLINA DOCG",       producer: "Cantina Nera", notes: "Rosso granato, complesso. Aromi di frutti rossi maturi, spezie, note tostate e sfumature di cacao",                      bottle: "55.00", glass: "" },
        { name: "TIRSO GRUMELLO SUPERIORE DOCG 0,375 L",     producer: "Cantina Nera", notes: "Rosso rubino con riflessi granati. Profumi di frutti di bosco, confettura e note floreali",                              bottle: "15.00", glass: "" },
        { name: "TIRSO GRUMELLO SUPERIORE DOCG 0,75 L",      producer: "Cantina Nera", notes: "Rosso rubino con riflessi granati. Profumi di frutti di bosco, confettura e note floreali",                              bottle: "26.00", glass: "" },
        { name: "ROSSO DI VALTELLINA DOC \"TOURING\"",       producer: "Cantina Nera", notes: "Tipico vino di qualità da tutto pasto, fresco e leggermente fruttato",                                                    bottle: "14.00", glass: "" },
        { name: "\"MAZER\" — VALTELLINA SUPERIORE DOCG",     producer: "Nino Negri", notes: "Una parte delle uve viene leggermente appassita. Profumi delicati di frutta rossa e spezie dolci",                       bottle: "31.00", glass: "" },
        { name: "\"VIGNA SASSOROSSO\" — GRUMELLO SUPERIORE DOCG", producer: "Nino Negri", notes: "Rosso rubino brillante, profumi di more, ribes, ciliegie e lamponi",                                               bottle: "45.00", glass: "" },
        { name: "5 STELLE SFURZAT VALTELLINA DOCG 2018",     producer: "Nino Negri", notes: "Rosso granato intenso, profumi complessi di frutta secca, spezie, note tostate e balsamiche",                            bottle: "110.00", glass: "" },
        { name: "5 STELLE SFURZAT VALTELLINA DOCG 2020",     producer: "Nino Negri", notes: "Vino potente, ricco e concentrato, note di frutta matura, spezie e sfumature balsamiche",                                bottle: "90.00", glass: "" },
        { name: "\"LE TENSE\" — SASSELLA SUPERIORE DOCG",    producer: "Nino Negri", notes: "Rosso rubino con riflessi granati. Aromi di frutti rossi in confettura, fiori appassiti e spezie leggere",               bottle: "31.00", glass: "" },
        { name: "VIGNA CA' GUICCIARDI INFERNO SUPERIORE DOCG", producer: "Nino Negri", notes: "Rosso rubino intenso, aromi di frutti rossi, viola appassita e spezie",                                               bottle: "45.00", glass: "" },
        { name: "\"CASTEL CHIURO\" VALTELLINA SUPERIORE DOCG Riserva 2013", producer: "Nino Negri", notes: "Profumi complessi di frutta sotto spirito, erbe aromatiche, tabacco e legno pregiato",                  bottle: "85.00", glass: "" },
    ...
    // --------------------------------------------------------
    {
      ...
      items: [
        ...
        { name: "LAGREIN",                            producer: "Cantina Madonna delle Vittorie", notes: "Al palato morbido, fresco e piacevolmente armonico, finale fruttato e scorrevole",                   bottle: "32.00", glass: "" },
    ...
    // --------------------------------------------------------
    {
      ...
      items: [
        ...
        { name: "ROERO ARNEIS RECIT DOCG",                producer: "Cantina Cabianca",  notes: "Fragrante e fine, aromi di pera, mela e fiori bianchi con un accenno di erbe delicate",   bottle: "26.00", glass: "" },
    ...
    // --------------------------------------------------------
    {
      ...
      items: [
        ...
        { name: "SAUVIGNON IGP",                                producer: "Kellerei Aichholz",  notes: "Intenso e profumato, aromi di foglia di pomodoro, pesca bianca ed erbe aromatiche",          bottle: "29.00", glass: "" },
